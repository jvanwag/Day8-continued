...
quizUsers.push(new QuizUser('Jon', 'jvanwag08@gmail.com', 'password', 100));
quizUsers.push(new QuizUser('Mike', 'balrog10@gmail.com', 'bannanagins', 90));
quizUsers.push(new QuizUser('Jake', 'jakeandmikev@gmail.com', 'bauk', 70));
...
questions.push(new Question('T/F: JavaScript is just a scripting version of Java', ['T', 'F'], 'T', 'medium'));
